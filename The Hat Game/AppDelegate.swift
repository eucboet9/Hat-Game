...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    static let notificationKey = "DataLoadedNotification"
    
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        // Override point for customization after application launch.
        
        let defaults = NSUserDefaults.standardUserDefaults()
        if defaults.valueForKey("DictsLoaded") == nil {
            //load from the net
            ...
            dispatch_async(dispatch_get_global_queue(qos, 0), { () -> Void in
                ...
                if let unwrappedData = data {
                    ...
                    defaults.setBool(true, forKey: "DictsLoaded")
                    
                    dispatch_async(dispatch_get_main_queue(), { () -> Void in
                        NSNotificationCenter.defaultCenter().postNotificationName("DataLoadedNotification", object: self)
                    })
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "ruslan.The_Hat_Game" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("The_Hat_Game", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("The_Hat_Game.sqlite")
